    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h10, "class", "svelte-3p6xda");
    			add_location(h10, file$3, 116, 0, 3540);
    			attr_dev(p0, "id", "writenum");
    			attr_dev(p0, "class", "svelte-3p6xda");
    			add_location(p0, file$3, 117, 4, 3606);
    			add_location(h11, file$3, 117, 0, 3602);
    			attr_dev(p1, "id", "predictionResult");
    			attr_dev(p1, "class", "svelte-3p6xda");
    			add_location(p1, file$3, 118, 0, 3651);
    			attr_dev(p2, "id", "arrowbody");
    			attr_dev(p2, "class", "svelte-3p6xda");
    			add_location(p2, file$3, 119, 0, 3698);
    			attr_dev(p3, "id", "triangle");
    			attr_dev(p3, "class", "svelte-3p6xda");
    			add_location(p3, file$3, 120, 0, 3721);
    			attr_dev(p4, "id", "accuracy");
    			attr_dev(p4, "class", "svelte-3p6xda");
    			add_location(p4, file$3, 121, 0, 3743);
    			attr_dev(canvas_1, "width", "500");
    			attr_dev(canvas_1, "height", "400");
    			attr_dev(canvas_1, "id", "canvasW");
    			attr_dev(canvas_1, "class", "svelte-3p6xda");
    			add_location(canvas_1, file$3, 123, 0, 3776);
    			add_location(div0, file$3, 115, 0, 3534);
    			attr_dev(button0, "id", "ButtonClear");
    			attr_dev(button0, "class", "svelte-3p6xda");
    			add_location(button0, file$3, 126, 2, 3860);
    			attr_dev(button1, "id", "ButtonPredict");
    			attr_dev(button1, "class", "svelte-3p6xda");
    			add_location(button1, file$3, 127, 2, 3923);
    			add_location(div1, file$3, 125, 0, 3850);
    			attr_dev(div2, "id", "tabbar");
    			attr_dev(div2, "class", "svelte-3p6xda");
    			add_location(div2, file$3, 114, 0, 3516);
    			attr_dev(body, "id", "pagePrediction");
    			attr_dev(body, "class", "svelte-3p6xda");
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "svelte-7hv3li");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1hm3oi5");
    			add_location(h1, file$1, 10, 2, 369);
    			attr_dev(div, "id", "box");
    			attr_dev(div, "class", "svelte-1hm3oi5");
    			add_location(div, file$1, 9, 2, 352);
    			attr_dev(button, "id", "ButtonGraph");
    			attr_dev(button, "class", "svelte-1hm3oi5");
